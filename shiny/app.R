...
# Create dataset
oregon_data <- structure(list(
  types_of_analysts = c("Operations & Policy Analyst\nProgram Analyst\nResearch Analyst\nFiscal Analyst\nHuman Resource Analyst\nCommunicable Disease Analyst", 
                        ...
                        "Operations & Policy Analyst\nFiscal Analyst\nHuman Resource Analyst\nPayroll Analyst\nProgram Analyst", 
                        "Operations & Policy Analyst\nProgram Analyst\nFiscal Analyst", 
                        "Program Analyst\nResearch Analyst", "Human Resource Analyst\nOperations & Policy Analyst\nResearch Analyst\nFiscal Analyst\nPayroll Analyst\nProgram Analyst", 
                        "Program Analyst\nFiscal Analyst\nOperations & Policy Analyst"
  ), 
  Agency = c("OREGON HEALTH AUTHORITY", "HUMAN SERVICES, DEPARTMENT OF", 
             "TRANSPORTATION, DEPT OF", "ADMINISTRATIVE SRVCS, DEPT OF", "EMPLOYMENT DEPT", 
             "EDUCATION, DEPT OF", "CORRECTIONS, DEPT OF", "CONSUMER AND BUS SRVCS, DEPT", 
             "REVENUE, DEPARTMENT OF", "HOUSING & COMM SRVCS, DEPT OF", "JUDICIAL DEPARTMENT", 
             "JUSTICE, DEPARTMENT OF", "ENVIRONMENTAL QUALITY, DEPT", "EARLY LEARNING AND CARE, DEPT OF", 
             "OR BUSINESS DEV DEPT", "HI-ED COORDINATING COMM", "PUBLIC EMPS RETIREMENT SYSTEM", 
             "YOUTH AUTHORITY, OREGON", "FORESTRY, DEPT OF", "EMERGENCY MANAGMENT, DEPT OF", 
             "PUBLIC UTILITY COMMISSION", "POLICE, OREGON STATE", "ENERGY, DEPARTMENT OF", 
             "PARKS & RECREATION, DEPT OF", "STATE FIRE MARSHALL, OFFICE OF THE", 
             "SECRETARY OF STATE", "LEGISLATIVE POLICY & RESEARCH COMMITTEE", 
             "LIQUOR CONTROL COMMISSION", "PUBLIC DEFENSE SERVICES", "MILITARY, DEPT OF", 
             "FISH & WILDLIFE, DEPT OF", "VETERANS AFFAIRS, DEPT OF", "AGRICULTURE, DEPT OF", 
             "CRIMINAL JUSTICE COMMISSION", "LEGISLATIVE FISCAL OFFICER", 
             "LEGISLATIVE COUNSEL COMMITTEE", "WATER RESOURCES, DEPT OF", 
             "LABOR & INDUSTRIES, BUREAU OF", "LONG TERM CARE OMBUDSMAN", 
             "PUBLIC SAFETY STANDARDS & TRNG", "Multiple Agencies"), 
  average_analyst_salary = c(98000, 98000, 1e+05, 118000, 85000, 98000, 113000, 98000, 102000, 89000, 
                             96000, 98000, 98000, 98000, 113000, 102000, 89000, 98000, 98000, 
                             94000, 108000, 89000, 98000, 98000, 102000, 102000, 119000, 98000, 
                             102000, 87000, 81000, 94000, 102000, 85000, 172000, 98000, 85000, 
                             102000, 98000, 91000, 98000), 
  total_analysts = c(1317, 1225, 438, 252, 236, 194, 171, 163, 162, 148, 129, 111, 105, 98, 87, 
                     85, 85, 77, 72, 65, 62, 61, 59, 54, 52, 41, 36, 33, 30, 28, 27, 
                     27, 23, 21, 19, 16, 14, 13, 13, 12, 7)), row.names = c(NA, -41L
                     ), class = "data.frame")
...
ui <- page_fluid(
  ...
  card(
    ...
    card_header(
      ...
      p(class = "text-muted", "Total count includes any FULL-TIME job classifications with \"analyst\" in the name for the 2024 fiscal year")
    ),
